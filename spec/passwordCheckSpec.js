...
describe("Password checker.Multiply conditions are not met", () => {
  ...
  it("Passwords that has numbers only with characters less than 8", () => {
    var password = "12345";
    var ansP = passwordCheck(password);
    expect(ansP).toBe("Error:The password needs to have 8 or more charecters,atleast a upper and lower case letters")
  });

  it("Password with lower case letters, a number and characters less than 8", () => {
    var password = "gafs2";
    var ansP = passwordCheck(password);
    expect(ansP).toBe("Error:The password needs to have 8 or more characters and have atleast an upper case letter")
  });
});